...
Also writes a standalone lookup: projects/girl_effect/full_text/data/zotero_to_eppi.csv

Usage:
    python pipeline/add_eppi_ids.py \
        --refs projects/girl_effect/full_text/references_20260718_204803.csv \
        --mapping "C:/Users/LucasSempe/Downloads/Copy of EPPI_ID_mapping.csv" \
        --reports-dir projects/girl_effect/full_text/reports
"""
...
def main():
    ...
    p.add_argument("--reports-dir", default="projects/girl_effect/full_text/reports", help="Directory with summary/triage CSVs")
    args = p.parse_args()
    ...
    lookup_path = Path("projects/girl_effect/full_text/data/zotero_to_eppi.csv")
