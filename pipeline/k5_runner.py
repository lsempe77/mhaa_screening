...
Usage:
    ...
    python pipeline/ingest.py --input projects/girl_effect/ta_screening/data/ground_truth.xlsx --out-dir projects/girl_effect/ta_screening/data
...
# projects/strongminds/prompts/ulcm-tas-screening-prompts-hierarchical.md §1/§2. The caller supplies
