...
Usage:
    python pipeline/make_gt_from_review.py \
        ...
        --out projects/girl_effect/full_text/data/gt_406.json
"""
...
def main():
    ...
    print(f"\nNext step:")
    print(f"  python pipeline/k5_runner.py --calibrate projects/girl_effect/full_text/output/results_fts_glm_388.jsonl --gt {out}")
