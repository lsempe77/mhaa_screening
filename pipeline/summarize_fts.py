...
Reads projects/girl_effect/full_text/output/results_fts_glm_388.jsonl and writes:
    projects/girl_effect/full_text/reports/summary.csv   one row per record:
...
Usage:
    python pipeline/summarize_fts.py --results projects/girl_effect/full_text/output/results_fts_glm_388.jsonl \
