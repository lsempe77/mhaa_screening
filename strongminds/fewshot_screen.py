...
def load():
    ...
    adj = [json.loads(l) for l in lines("strongminds/gt_adjudication.jsonl")]
    ...
    v16 = {}
    for l in lines("strongminds/data/output/results_orch_v16_510.jsonl"):
        d = json.loads(l)
        v16[str(d["record_id"])] = {
...
def main():
    ...
    (HERE / f"fewshot_results_{tag}.json").write_text(json.dumps(out, ensure_ascii=False, indent=1), encoding="utf-8")
    print(f"\nWrote {HERE / f'fewshot_results_{tag}.json'}")
