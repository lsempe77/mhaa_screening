...
2. EXCLUDE_STUDY_DESIGN — for review-level screening, require a systematic review, meta-analysis, umbrella review, network meta-analysis, Cochrane review, or other evidence synthesis. Fail primary studies, narrative reviews without systematic search, protocols without results, editorials, commentaries. NOTE: a review that does NOT label itself "systematic" but describes searching named databases (PubMed, EMBASE, PsycINFO, MEDLINE) with explicit inclusion criteria and a stated number of included articles IS a systematic evidence synthesis — do NOT exclude merely because the term "systematic review" is absent. MISSING-ABSTRACT RULE: when the abstract is missing/NA and the title suggests an in-scope review or topic, do NOT fail on study design — mark UNCERTAIN and RETAIN (the governing rule: missing information defaults to inclusion; the record will be checked at full-text).
