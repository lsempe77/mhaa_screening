...
def load_dataset():
    ...
    records = {}
    for l in (ROOT / "projects/strongminds/data/records_510.jsonl").read_text(encoding="utf-8").split("\n"):
        if l.strip():
            r = json.loads(l)
...
def main():
    ...
    outpath = ROOT / "projects/strongminds/artifacts/gt_adjudication.jsonl"
