...
Outputs:
    GE_FTS/reports/excludes_triage.csv  — the 30 EXCLUDE decisions (highest stakes)
    GE_FTS/reports/flags_triage.csv     — the 258 needs_second_opinion INCLUDEs
...
def main():
    results_path = "GE_FTS/output/results_fts_glm_388.jsonl"
    records_path = "GE_FTS/data/records_388.jsonl"
    out_dir = Path("GE_FTS/reports")
